...
对于高级版和 BYOL 许可证，磁盘限制可防止您单独使用磁盘来达到 368 TB 容量限制。您可以通过达到 368 TB 容量限制 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-data-tiering.html["将非活动数据分层到对象存储"^]。有关详细信息，请参见以下磁盘限制。
